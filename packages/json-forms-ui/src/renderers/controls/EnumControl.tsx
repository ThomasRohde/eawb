...
function EnumControlImpl(props: ControlProps & OwnPropsOfEnum) {
  const {
    data,
    handleChange,
    path,
    ...
    >
      <Dropdown
        ...
        onOptionSelect={(_e, d) => {
          ...
          // Round-trip the value type from options so numeric enums stay numeric.
...
export const EnumControl = withJsonFormsEnumProps(EnumControlImpl);
